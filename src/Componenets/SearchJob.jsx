            ...
            <div className="container search_job_header">
              <div className="row">
                <div className="col job_search">
                  ...
                  <h1 className="display1 mt-5" style={{  fontWeight: 'bold', color: "black" }}>
                    You can Search Job
                    <br />
                ...
                <div className="row">
                  <div className="col">
                    <div id="searchjob" className="col-2 m-auto">
                      <button type="submit" class="btn btn-success mt-5" style={{  fontWeight: 'bold', color: "black" }}>
                        search
                      </button>
                    </div>
                  </div>
              ...
              <div className="empContent">
                <div className="emp1">
                  ...
                  AllServiceHub is a leading provider of housing services, offering a wide array of essential maintenance solutions to homeowners. 
                  With expertise in plumbing, painting, housekeeping, water tank cleaning, pest control, and AC repair, they provide a comprehensive approach to home care.
                   Their commitment to excellence ensures that customers receive reliable and efficient service, addressing their needs promptly and effectively. 
                   AllServiceHub stands out for their dedication to quality and customer satisfaction, 
                  making them a preferred choice for homeowners seeking top-notch home maintenance solutions.
                  </p>
                  </div>
